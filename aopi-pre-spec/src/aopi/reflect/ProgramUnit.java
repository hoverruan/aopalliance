 ...
 * locators using <code>getLocator()</code> or more specific
 * methods. This locators shall be used conjointly whith an
 * <code>aopi.modif.ProgramModifier</code> implementation in order to
