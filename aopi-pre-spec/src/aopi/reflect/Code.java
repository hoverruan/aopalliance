 ...
 * conjointly whith an <code>aopi.modif.ProgramModifier</code>
 * implementation in order to perform aspetual transformations of the
 * program (before/after/around type).
 *
 * <p>The <code>getLocator</code> method returns the locator for the
 * whole method and can be used to implement callee-side
 * transformations before/after/around the callee method.
 *
